...
# test_img_dir = Path("/data2/datasets/clobotics/ccth/images/cropped/versions/train20200129_val20200117_test20191122/batch5")
# results_save_dir = Path("/tmp/vis/batch5")
test_img_dir = Path("/data2/datasets/clobotics/ccth/images/cropped/versions/train20200129_val20200117_test20191122/val")
results_save_dir = Path("/tmp/vis/val")
